...
namespace XoopsCube\Installer\Tests\Join\Service;

use PDO;
use XoopsCube\Installer\Service\SiteConstructionService;
use XoopsCube\Installer\Service\ServiceException;
...
use XoopsCube\Installer\Database\SqlUtility;
use XoopsCube\Installer\Security\MD5PasswordEncryptor;
use XoopsCube\Installer\Tests\SandboxDirectoryManager;
...
class SiteConstructionServiceTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @return \XoopsCube\Installer\ValueObject\Site
     */
...
define('XOOPS_DB_PCONNECT', 0);";
    ...
    public function testConstruct()
    {
        ...
        $this->assertTableExists('xoops_foo');
        $this->assertTableExists('xoops_users');
        $this->assertTableEquals(array(
            array('dummy1'),
            array('dummy2'),
            array('dummy3'),
        ), 'xoops_foo');
        $this->assertTableRowCount(1, 'xoops_users');
    ...
    public function testConstructThrowsExceptionWhenFailedToWriteConfig()
    {
        ...
        $this->setExpectedException(
            'XoopsCube\Installer\Service\ServiceException',
    ...
    public function testConstructRemoveConfigFileWhenDatabaseProcessFails()
    {
        ...
        $connectionFactory = $this->getMock('XoopsCube\Installer\Database\ConnectionFactory');
        $connectionFactory
            ->expects($this->once())
